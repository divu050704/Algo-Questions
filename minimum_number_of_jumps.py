...
def minimum_number_of_jumps(x):#function defined for a list 'x'
    ...
    print('Minimum number of jumps:\t',len(k)+1)#Print number of steps (number of elements in the list ), added 1 because it will not count the first element 
l = [1,3,5,8,9,2,6,7,6,8,9]
minimum_number_of_jumps(l)
'''
Output of the program
Original list:   [1, 3, 5, 8, 9, 2, 6, 7, 6, 8, 9]
