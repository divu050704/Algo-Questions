...
def minimize_hieghts(x,k):#given the list as 'x' and the value of k as 'k' only
    ...
    print('Minimum difference between heights:\t',l[int(size-1)]-l[0])#Then finally subtract the larget number from lowest number in the list(last - first)
l = [1,5,8,10]
k = 2
minimize_hieghts(l,k)
'''
Output of the program
Original list:   [1, 5, 8, 10]
Value of k:      2
Minimum difference between heights:      5
'''
